...
export default function () {
  ...
  return (
    <div class="privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Playing With ML, &lt;address&gt;.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Neurodeploy, accessible from{" "}
            <a
              href="https://console.neurodeploy.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://console.neurodeploy.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@neurodeploy.com</li>
      </ul>
    </div>
  );
}
